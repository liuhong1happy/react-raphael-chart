		...
		value: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					Set,
					null,
					React.createElement(Text, { x: site.x, y: site.y + 10, text: String(site.v), attr: { "fill": color }, hide: true, translate: { x: 0, y: 10 } }),
...
var VoronoiLineChart = function (_React$Component2) {
	...
	function VoronoiLineChart(props) {
		_classCallCheck(this, VoronoiLineChart);

		var _this2 = _possibleConstructorReturn(this, (VoronoiLineChart.__proto__ || Object.getPrototypeOf(VoronoiLineChart)).call(this, props));
	...
	_createClass(VoronoiLineChart, [{
		...
		value: function getSeriseAllPoints(props) {
			var width = props.width,
			    height = props.height,
			    serises = props.serises,
			    xAxis = props.xAxis,
			    yAxis = props.yAxis;
