		...
		value: function render() {
			...
			return React.createElement(
				...
				xValues.map(function (ele, pos) {
					return React.createElement(Line, { x1: ele.x, y1: yMin, x2: ele.x, y2: yMax, attr: { "stroke": color, "stroke-width": thickness } });
				}),
				yValues.map(function (ele, pos) {
					return React.createElement(Line, { x1: xMin, y1: ele.y, x2: xMax, y2: ele.y, attr: { "stroke": color, "stroke-width": thickness } });
				})
			);
		}
	}]);
	...
	_createClass(YAxis, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				null,
				yValues.map(function (ele, pos) {
					return React.createElement(Line, { x1: ele.x1, y1: ele.y, x2: ele.x2, y2: ele.y, attr: { "stroke": color, "stroke-width": thickness } });
				}),
				yValues.map(function (ele, pos) {
					return React.createElement(Text, { x: ele.x1 - 12, y: ele.y, text: ele.label, attr: { "fill": ele.color, "text-anchor": "end", "font-size": 14 } });
				})
			);
		}
	}]);
	...
	_createClass(XAxis, [{
		...
		value: function render() {
			...
			return React.createElement(
				...
				null,
				xValues.map(function (ele, pos) {
					return React.createElement(Line, { x1: ele.x, y1: ele.y1, x2: ele.x, y2: ele.y2, attr: { "stroke": color, "stroke-width": thickness } });
				}),
				xValues.map(function (ele, pos) {
					return React.createElement(Text, { x: ele.x, y: ele.y2 + 12, text: ele.label, attr: { "fill": ele.color, "font-size": 14 } });
				})
			);
		}
	}]);
...
var Axis = function (_React$Component5) {
	...
	_createClass(Axis, [{
		...
		value: function render() {
			...
			var data = Utils.getAxisData({ width: width, height: height, xAxis: xAxis, yAxis: yAxis });

			return React.createElement(
				Set,
				null,
				React.createElement(XAxis, { xValues: data.xValues, grid: grid }),
