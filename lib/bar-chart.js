			...
			return React.createElement(
				...
				data.map(function (ele, pos) {
					return React.createElement(
						...
						React.createElement(Text, { key: "text" - pos, x: ele._x, y: ele._y - 5, text: String(ele.y), attr: { "fill": serise.hoverColor }, hide: true })
					);
				})
			);
		}
		...
		value: function render() {
			...
			return React.createElement(
				...
				serises.map(function (ele, pos) {
					return React.createElement(BarSerise, { key: pos, ref: "serise" + pos, index: pos, count: serises.length + 1, width: width, height: height,
